<x-util.card size="col-xl-6 col-md-6 mb-3" title="Spiel Vorbei // Gewonnen hat {{ $match->team2->name }} // Getippt wurde für {{ $match->team1->name }}" small-title>
    <x-slot name="body">
        <p>
            <div align="center">
    ...
    <x-slot name="footer" class="d-flex justify-content-around">
        <button type="button" class="btn btn-{{ $colors["user_wrong_tipp"] }} px-xl-5 px-4" disabled><i class="fas fa-plus"></i></button>
