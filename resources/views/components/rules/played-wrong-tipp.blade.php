<div id="Match-Test-Open" class="col-xl-6 col-md-6 mb-3">
    <div class="card">
        <div class="card-header">
            Spiel Vorbei // Gewonnen hat {{ $match->team2->name }} // Getippt wurde für {{ $match->team1->name }}
        </div>
        <div class="card-body">
            <p>
                <div align="center">
        ...
        <footer class="card-footer d-flex justify-content-around">
            <button type="button" class="btn btn-dark px-xl-5 px-4" disabled><i class="fas fa-plus"></i></button>
            <button type="button" class="btn btn-secondary px-xl-5 px-4" disabled><i class="fas fa-equals"></i></button>
            <button type="button" class="btn btn-success px-xl-5 px-4" disabled><i class="fas fa-plus"></i></button>
        </footer>
    </div>
</div>
